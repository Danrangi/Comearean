...
# --- CONFIGURATION ---
# MUST MATCH src/app/__init__.py EXACTLY
...
class KeyGeneratorApp:
    def __init__(self, root):
        ...
        # Title
        tk.Label(root, text="License Generator", font=("Arial", 16, "bold"), bg="#f0f0f0", fg="#333").pack(pady=20)

        # System ID Input
        tk.Label(root, text="Client System ID:", bg="#f0f0f0", font=("Arial", 10)).pack(anchor="w", padx=20)
        self.entry_sys_id = tk.Entry(root, font=("Arial", 11), width=40)
        self.entry_sys_id.pack(pady=5, padx=20)

        # Duration Input
        tk.Label(root, text="Duration (Days):", bg="#f0f0f0", font=("Arial", 10)).pack(anchor="w", padx=20)
        ...
        # Output Area
        tk.Label(root, text="Activation Key (Copy this):", bg="#f0f0f0", font=("Arial", 10)).pack(anchor="w", padx=20)
